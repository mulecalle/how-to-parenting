# Homework Pre Sanatorio 

1. **Comida:** Cerca de la semana 38 es un buen momento para abastecer alacenas y freezer “a lo apocalipsis zombie”. Abastecé lo máximo que puedas.
2. **Cosas del bebé:** Indispensables para ir comprando y guardando; si enganchás alguna oferta, mejor.
    - Pañales:
...
3. **Limpieza del hogar:** La primera semana pos sanatorio es caótica. Según la fecha probable de parto, intentá dejar la casa lo más limpia y ordenada posible para volver con una preocupación menos.
4. **Bolucompras:**
    - [Almohadón de lactancia](https://www.littleabbyshop.com/lactancia-y-contencion/almohadones-amamantar/): Súper cómodo para la mamá, el bebé y el papá (te ahorra acomodar almohadones cada 5 minutos). A nosotros nos resultó perfecto. - _5/5_ 
    - [Nidito](https://www.lamb.com.ar/productos/nido-de-contencion-vicky/): En la tercera semana de vida, durante el día hay cierta chance de que la beba duerma sola acá. No está mal, pero tiene vida útil corta. - _3/5_
    - [Cuna colecho](https://www.carestino.com/producto/cuna-colecho-madison-gris): Similar al anterior: es muy difícil que duerma sola de día y de noche, casi imposible. - _2/5_ 
...
5. **Temperatura:** La idea es mantener el ambiente cerca de 25 °C. Dependiendo de la fecha de parto, andá pensando cómo lo vas a lograr.
